            ...
            >
              ...
              <div className="pt-1 flex items-center justify-end gap-2">
                ...
                <button
                  ...
                  className="px-5 py-2.5 rounded-xl text-xs font-extrabold uppercase tracking-wider bg-[var(--brand-primary)] hover:brightness-110 text-white shadow-md transition-all flex items-center gap-2 cursor-pointer"
                >
